...
if __name__ == "__main__":
    ...
    seg_model_name = "best_Yat-sen_University_orchid-idea.v7i.v8s-C2f-FasterBlock_seg.pt"

    img = cv2.imread(r"o2.jpg")
    ...
    ALL_results_rows, img, csv_data, img_name, exetime, exetime2, exetime3 = orchid_pose_seg_area_leafs_number_predict(img, pose_model_name, 
    ...
    if ALL_results_rows is None or len(ALL_results_rows) == 0:
        ...
        for i in range(len(best_route)):
            ...
            if i > 0:
                ...
                if loc[3] < 0:
                    # 夾爪順時針轉
                    print(f'夾爪順時針轉{abs(loc[3])}度') # 夾爪要對齊植株介質的角度
                    ...
                    # 夾爪逆時針轉
                    print(f'夾爪逆時針轉{abs(loc[3])}度') # 夾爪要對齊植株介質的角度
