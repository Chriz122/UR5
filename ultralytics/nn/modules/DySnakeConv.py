...
from .block import C3, C2f, Bottleneck, RepNCSP
...
class DySnakeRepNCSPELAN4(nn.Module):
    # csp-elan
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, number, shortcut, groups, expansion
        super().__init__()
        self.c = c3//2
        self.cv1 = Conv(c1, c3, 1, 1)
        self.cv2 = nn.Sequential(RepNCSP(c3//2, c4, c5), DySnakeConv(c4, c4))
        self.cv3 = nn.Sequential(RepNCSP(c4, c4, c5), DySnakeConv(c4, c4))
