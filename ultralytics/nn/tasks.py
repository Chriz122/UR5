    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            args = [*args[1:]]
                   ...
                   sparx_mamba_t, sparx_mamba_s, sparx_mamba_b, groupmamba_tiny, groupmamba_small, groupmamba_base, partialnet_s, partialnet_m, partialnet_l, MobileMamba_T2, MobileMamba_T4, MobileMamba_S6, 
                   MobileMamba_B1, MobileMamba_B2, MobileMamba_B4, vcmamba_efficientformer_s, vcmamba_efficientformer_m, vcmamba_efficientformer_b, defm_tiny, defm_small, defm_base}:
            m = m(*args)
            c2 = m.width_list 
            backbone = True
        else:
